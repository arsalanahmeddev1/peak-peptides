...
class CmsModulePermissions extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $leagueContractorRole = Role::firstOrCreate(['name' => config('roles.league_contractor')]);
        $modules = [
        ...
        $permissions = [
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $modules['subscriptions']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 1, 'is_delete' => 0], // Subscriptions
            ['role_id' => $leagueContractorRole->id, 'module_id' => $modules['payments']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 0, 'is_delete' => 0], // payments
            ['role_id' => $leagueContractorRole->id, 'module_id' => $modules['referrals']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 1, 'is_delete' => 0], // referrals
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $modules['products']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 1, 'is_delete' => 0], // products
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $modules['packages']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 0, 'is_delete' => 0], // packages
            // Submenus
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $submenus['subscriptions.index']->id ?? null, 'is_add' => 0, 'is_view' => 1, 'is_update' => 1, 'is_delete' => 0], // All Subscriptions (subscriptions.index)
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $submenus['services.bookings']->id ?? null, 'is_add' => 0, 'is_view' => 1, 'is_update' => 0, 'is_delete' => 0], // Services bookings
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $submenus['products.create-categories']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 0, 'is_delete' => 0], // Create Category (admin only - no access)
            ['role_id' => $leagueContractorRole->id, 'module_id' => $submenus['products.categories.index']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 0, 'is_delete' => 0], // All Categories (admin only - no access)
            ...
            ['role_id' => $leagueContractorRole->id, 'module_id' => $submenus['admin.packages.index']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 0, 'is_delete' => 0], // All Packages (admin.packages.index)
            ['role_id' => $leagueContractorRole->id, 'module_id' => $submenus['admin.packages.create']->id ?? null, 'is_add' => 0, 'is_view' => 0, 'is_update' => 0, 'is_delete' => 0], // Add Package (admin.packages.create)
        ];
